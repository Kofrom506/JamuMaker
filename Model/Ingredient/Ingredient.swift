...
let cabe = Ingredient(name: "Chili", imageName: "cabe", code: "C", description: "Cabe or chili pepper is a popular spice that is widely used in Indonesian cuisine. It contains capsaicin, a compound that has anti-inflammatory and pain-relieving properties. Chili peppers are also a good source of vitamin C and are used in many Indonesian dishes to add heat and flavor. Chili peppers are found in many parts of Indonesia, particularly in Kalimantan and Papua.", location: [.kalimantan, .papua])
...
let kencur = Ingredient(name: "Galangal", imageName: "kencur", code: "H",description: "Kencur or galangal is a root spice that is used in Indonesian cuisine. It has anti-inflammatory and antibacterial properties and is known to aid digestion. Kencur is mainly found in  Sumatra.", location: [.sumatra])
let kunyit = Ingredient(name: "Turmeric", imageName: "kunyit", code: "I",description: "Kunyit or turmeric is a spice that is widely used in Indonesian cuisine. It has anti-inflammatory and antioxidant properties and is known to improve brain function and lower the risk of heart disease. Turmeric is found in many parts of Indonesia, particularly in Sumatra and Bali.", location: [.sumatra])
...
let serai = Ingredient(name: "Lemongrass", imageName: "serai", code: "L",description: "Serai or lemongrass is a herb that is widely used in Indonesian cuisine. It has anti-inflammatory and antioxidant properties and is known to aid digestion and boost the immune system. Lemongrass is found in many parts of Indonesia, particularly in Sulawesi.", location: [.sulawesi])
