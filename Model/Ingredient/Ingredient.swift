...
let kencur = Ingredient(name: "Galangal", imageName: "kencur", code: "H",description: "Kencur or galangal is a root spice that is used in Indonesian cuisine. It has anti-inflammatory and antibacterial properties and is known to aid digestion. Kencur is mainly found in Java and Sumatra.", location: [.jawa, .sumatra])
...
let madu = Ingredient(name: "Honey", imageName: "madu", code: "J",description: "Madu or honey is a natural sweetener that is rich in antioxidants and has antibacterial and anti-inflammatory properties. Honey is found in many parts of Indonesia, particularly in Sulawesi and Java.", location: [.jawa, .sulawesi])
